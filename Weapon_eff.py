...
Weak_coef = st.sidebar.number_input("약점 계수", min_value=1.00, max_value=1.20, value=1.00, step=0.10, format="%.2f")
sk_coef = st.sidebar.number_input("스킬 계수(%)", min_value=0.0, value=100.0, step=10.0, format="%.0f")
buff_x = st.sidebar.number_input("피해 증가(%)", min_value=0.0, value=0.0, step=10.0, format="%.0f")
buff_y = st.sidebar.number_input("치명 피해(%)", min_value=0.0, value=120.0, step=10.0, format="%.0f")
